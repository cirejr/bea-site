...
import { ArrowUpDownIcon, ChevronDownIcon, MoreHorizontalIcon } from "@hugeicons/core-free-icons"
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button variant="outline" className="ml-auto">
              Columns <HugeiconsIcon icon={ChevronDownIcon} className="ml-2 h-4 w-4" />
            </Button>
          </DropdownMenuTrigger>
          <DropdownMenuContent align="end">
            {table
