...
export const formationModalities = pgTable(
  "formation_modalities",
  {
    ...
    modalityId: integer()
      .notNull()
      .references(() => modalites.id),
  },
  (t) => [primaryKey({ columns: [t.formationId, t.modalityId] })]
)
...
export const formationBadges = pgTable(
  "formation_badges",
  {
    formationId: integer()
      .notNull()
  ...
  (t) => [primaryKey({ columns: [t.formationId, t.badgeId] })]
)

export const formationsComplementaires = pgTable(
  "formations_complementaires",
  {
    ...
    formationId: integer()
      .notNull()
      .references(() => formations.id, { onDelete: "cascade" }),
    complementaryFormationId: integer()
      .notNull()
      .references(() => formations.id, { onDelete: "cascade" }),
  },
  (t) => ({
...
export const formationsRelated = pgTable(
  "formations_related",
  {
    formationId: integer()
      .notNull()
      .references(() => formations.id, { onDelete: "cascade" }),
    relatedFormationId: integer()
      .notNull()
      .references(() => formations.id, { onDelete: "cascade" }),
    sortOrder: integer().default(0).notNull(),
  },
...
export const formationCertifications = pgTable(
  ...
  (t) => [primaryKey({ columns: [t.formationId, t.certificationId] })]
)
...
export const faqs = pgTable("faqs", {
  ...
  formationId: integer().references(() => formations.id, {
    onDelete: "cascade",
  }),
  certificationId: integer().references(() => certifications.id, {
    onDelete: "cascade",
  }),
  isActive: boolean().default(true).notNull(),
  sortOrder: integer().default(0).notNull(),
